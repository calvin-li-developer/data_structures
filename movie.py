...
class Movie:
    ...
    def __init__(self, title, year, director, rating, genres):
        ...
        -------------------------------------------------------
        """
        assert year >= Movie.FIRST_YEAR or None, "Movie year must be >= {}".format(
            Movie.FIRST_YEAR)
        ...
        assert genres == None or genres == [] or min(genres) in Movie.GENRE_CODES, "Invalid genre code {}".format(
            min(genres))
        assert genres == None or genres == [] or max(genres) in Movie.GENRE_CODES , "Invalid genre code {}".format(
            max(genres))
