...
class SortedList:
    ...
    def count(self, key):
        ...
        i = self._binary_search(key)
        number = 0
        while i != -1 and self._values[i] == key:
            number += 1
            i += 1
    ...
    def clean(self):
        ...
        while x < len(self._values):
            ...
            while x < len(self._values)-1 and self._values[x] == self._values[x+1]:
                self._values.pop(x+1)
#                 print(self._values)
            x+=1
    ...
    def intersection(self, rs):
        ...
        # your code here
        new_list = SortedList()
        if len(self._values)!= 0 and len(rs._values)!= 0:
            for i in self._values:
                if i not in new_list._values:
                    new_list._values.append(i)
            i = 0
            while i < len(new_list._values):
                while new_list._values[i] not in rs._values:
                    new_list._values = new_list._values[1:]         
                i +=1
        return new_list
